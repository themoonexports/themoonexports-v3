      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-12 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center">
          ...
          <div className="relative">
            ...
            />
            {/* Floating Card */}
            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-lg ring-1 ring-gray-900/10">
              <div className="text-center">
                <div className="text-xl font-bold text-indigo-600">2015</div>
        ...
        <div className="mt-16 sm:mt-20">
          ...
          <div className="mx-auto mt-12 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 sm:mt-16 sm:grid-cols-2 sm:gap-y-12 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            {stats.map((stat) => (
